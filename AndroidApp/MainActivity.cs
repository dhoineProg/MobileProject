...
namespace AndroidApp
{
    ...
    public class MainActivity : Activity
    {
        ...
        private void AddElementsToParentLayout()
        {
            ...
            var mButton = createButton.OnCreate("Button",ViewGroup.LayoutParams.MatchParent,120,15,15,24f);
            ...
            var ButtonForBBlock2 = createButton.OnCreate("Button", ViewGroup.LayoutParams.MatchParent, 120, 15, 15, 24f);
            ButtonForBBlock2.Click += MyButton_Click;
            var ButtonBottom = createButton.OnCreate("Button", ViewGroup.LayoutParams.MatchParent, 120, 0, 0, 24f);
            ...
            elements.AddLabelAndImageToBlock(block1,"Header",
                Resource.Drawable.starblue, "#FFFFFF", Typeface.CreateFromAsset(Assets, "Roboto-bold.ttf"), Typeface.DefaultBold, TypefaceStyle.Normal, 22, 13, "Subheader", null, false);
            ...
            elements.AddToBlock(block11, buttonUp2, "Header", Typeface.CreateFromAsset(Assets, "Roboto-bold.ttf"));
            var block12 = createElements.CreateBlock();
            elements.AddToBlock(block12, buttonUp3, "Header", Typeface.CreateFromAsset(Assets, "Roboto-bold.ttf"));
            var block13 = createElements.CreateBlock();
            elements.AddToBlock(block13, buttonUp4, "Header", Typeface.CreateFromAsset(Assets, "Roboto-bold.ttf"));
            int count = 4;
